...
load_data = read.csv("../data/ercot/ercot/load_data.csv")
head(load_data)
...
temperature_impute = read.csv("../data/ercot/ercot/temperature_impute.csv", row.names=1)
station_data = read.csv("../data/ercot/ercot/station_data.csv", row.names=1)
